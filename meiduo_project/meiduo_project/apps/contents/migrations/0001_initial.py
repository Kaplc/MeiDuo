# Generated by Django 3.2.16 on 2022-11-25 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='contents.brand', verbose_name='品牌')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specs', to='contents.spu', verbose_name='商品SPU')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='contents.spuspecification', verbose_name='规格')),
            ],
            options={
                'verbose_name': '规格选项',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creat_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='contents.specificationoption', verbose_name='规格值')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specs', to='contents.sku', verbose_name='sku')),
                ('spec', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='contents.spuspecification', verbose_name='规格名称')),
            ],
            options={
                'verbose_name': 'SKU规格',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contents.sku', verbose_name='sku')),
            ],
            options={
                'verbose_name': 'SKU图片',
        ...
        migrations.AddField(
            model_name='sku',
            name='spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contents.spu', verbose_name='商品'),
        ),
        migrations.CreateModel(
            name='GoodsChannel',
            fields=[
